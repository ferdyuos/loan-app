...
<body>
      ...
      <nav class="navbar"> <!-- opening Nav navbar Tag -->
            <div class="container_fluid">   <!-- opening Div container_fluid Tag -->
              ...
              <div class="searchprofile"> <!-- opening SearchProfile Tag -->
                  <form class="navbar_form" action="entitysearch.php" method="GET">
                    <div class="search">
                    ...
                    <a href="" class="">
                      ...
                      <ul class="dropdown"> <!-- opening DropDown Tag -->
                       <!-- <li class="dropdown_item"> <a class="" href="#">Profile</a> </li>
                        ...
                        <li class="dropdown_item"> <a class="" href="entities.php?logout='1'">Log out</a> </li>    
            ...
            <div class="totver" >  <!-- opening Total Verified Tag , also by verification cards-->
              ...
              <div class="card_body">
                ...
                <?php
                    ...
                    $users = "SELECT count(id) FROM entities ORDER by id ASC";
                    ...
                    if ($page) {
                    echo '<a href="entities.php"><button><<</button></a>';// Button for first page [<<]
                    echo '<a href="entities.php?page='.$page_down.'"><button><</button></a>';// Button for previous page [<]
                    } 

                    for ($i=1;$i<=$pages_total;$i++) {
                    if(($i==$page+1)) {
                    echo '<a href="entities.php?page='.$i.'"><button class="active">'.$i.'</button></a>';// Button for active page, underlined using 'active' class
                    }
                    ...
                    echo '<a href="entities.php?page='.$i.'"><button>'.$i.'</button></a>'; }
                    } 

                    if (($page + 1) != $pages_total) {
                    echo '<a href="entities.php?page='.$page_up.'"><button>></button></a>';// Button for next page [>]
                    echo '<a href="entities.php?page='.$pages_total.'"><button>>></button></a>';// Button for last page [>>]
                    }
                  ...
                  <table class="card_table">
                    ...
                    <tbody>
                      <?php
                        $mysqli = new mysqli("localhost:3306", "emeka", "emeka123", "loan") or die ("connection failed: " .$mysqli->connect_error());
                        $query = $mysqli->query("SELECT id,email,name,cac_number,sub_id,verified from entities  ORDER by id ASC LIMIT $offset, $per_page");
                        ...
                        while($row = mysqli_fetch_array($query))
                        {
                          ...
                          Print '<td align="center">'. $row['cac_number'] . "</td>";
                          Print '<td align="center">'. $row['sub_id'] . "</td>";
                          Print '<td align="center">'. $row['verified'] . "</td>";
                          Print '<td align="center"><a href="#" onclick="deleter('.$row['id'].')"> delete</a> </td>';
                          Print "</tr>";
                        }
                      ?>        
                    </tbody>
  ...
  <script>
    ...
    if (r==true)
      {
        window.location.assign("entitydelete.php?id=" + id);
      }
    }
  </script>
