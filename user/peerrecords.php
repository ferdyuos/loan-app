...
<body>
				        ...
				        <ul class="profile_drop_menu" > <!-- opening Profile DropDown Menu Tag -->
				        	<li class="profiledrop">
				            	...
				            	<!--	<li class="dropdown_item"> <a class="" href="#">Profile</a> </li>
				            		...
				            		<li class="dropdown_item"> <a class="" href="peerrecords.php?logout='1'">Log out</a> </li>    
            ...
            <div class="totver" >  <!-- opening Total Verified Tag , also by verification cards-->
                ...
                <div class="nav_tab">
                  <p class=""> 
                    <?php
                      ...
                      $query = "SELECT COUNT(*) from peer_record where status IS NULL and sender_username IS NULL";
              ...
              <div class="card_body">
                <div class="tab-pane active">  <!-- opening Users Tag -->
                    ...
                    $users = "SELECT count(id) FROM peer_record where status IS NULL and sender_username IS NULL ORDER by id ASC";
                    ...
                    if ($page) {
                    echo '<a href="peerrecords.php"><button><<</button></a>';// Button for first page [<<]
                    echo '<a href="peerrecords.php?page='.$page_down.'"><button><</button></a>';// Button for previous page [<]
                    } 

                    for ($i=1;$i<=$pages_total;$i++) {
                    if(($i==$page+1)) {
                    echo '<a href="peerrecords.php?page='.$i.'"><button class="active">'.$i.'</button></a>';// Button for active page, underlined using 'active' class
                    }
                    ...
                    echo '<a href="peerrecords.php?page='.$i.'"><button>'.$i.'</button></a>'; }
                    } 

                    if (($page + 1) != $pages_total) {
                    echo '<a href="peerrecords.php?page='.$page_up.'"><button>></button></a>';// Button for next page [>]
                    echo '<a href="peerrecords.php?page='.$pages_total.'"><button>>></button></a>';// Button for last page [>>]
                    }
                  ...
                  <table class="card_table">
                    ...
                    <tbody>
                      <?php
                        ...
                        $query = $mysqli->query("SELECT peer_record.id,peer_record.recipient_username,peer_record.amount,peer_record.description,users.ratings,users.username from peer_record INNER JOIN users ON peer_record.recipient_username=users.username WHERE status IS NULL and sender_username IS NULL ORDER by id ASC LIMIT $offset, $per_page");
  ...
  <script>
    ...
    if (r==true)
      {
        window.location.assign("peersendfund.php?id=" + id);
      }
    }
  </script>
