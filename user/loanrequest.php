		...
		<div class="main_panel"> <!-- opening Div Main Panel Tag -->
				        ...
				        <ul class="profile_drop_menu" > <!-- opening Profile DropDown Menu Tag -->
				        	<li class="profiledrop">
				            	...
				            	<!--	<li class="dropdown_item"> <a class="" href="#">Profile</a> </li>
				            		...
				            		<li class="dropdown_item"> <a class="" href="loanrequest.php?logout='1'">Log out</a> </li>    
            ...
            <form method="post" action="loanrequest.php">
              ...
              <?php echo display_error(); ?>
                  ...
                  <div class="input-group">
                    <label>Entity Username (Optional)</label>
                    <input type="text" name="entity_username">
                  </div>
              ...
              <div class="input-group">
                <button type="submit" class="btn" name="loan_request_btn">Apply</button>
              </div>
            </form>
